...
# it can also start by using the same methods to break the entire encrypted message into sub-arrays of 4 digits each and return the index values of the final 7 characters.
